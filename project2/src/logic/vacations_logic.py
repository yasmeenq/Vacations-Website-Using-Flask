...
class VacationsLogic:
    ...
    def add_new_vacation(self, vacation):
        ...
        if vacation.vacationImage and vacation.vacationImage.filename:
        ...
        VALUES (%s, %s, %s, %s, %s, %s);
        """
        params = (vacation.countryID, vacation.description, vacation.startDate, vacation.endDate, vacation.price, image_name)
    ...
    def add_country_if_not_exists(self, countryName):
        ...
        self.dal.insert(sql_insert, (countryName,))  # Perform the insert operation
